...
func TestNewMetrics(t *testing.T) {
	...
	m := NewMetrics(Results{
		&Result{500, time.Unix(0, 0), 100 * time.Millisecond, 10, 30, "Internal server error", Target{}},
		&Result{200, time.Unix(1, 0), 20 * time.Millisecond, 20, 20, "", Target{}},
		&Result{200, time.Unix(2, 0), 30 * time.Millisecond, 30, 10, "", Target{}},
	})
